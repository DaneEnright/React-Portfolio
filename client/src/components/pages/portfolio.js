    ...
    const portfolio = [
     {
        ...
        title:"Night Sky",
        description:"Really cool application that shows you where the International Space Station is currently located in real time. Also can enter your personal cordinates and see how far away it is from you at that exact moment!",
